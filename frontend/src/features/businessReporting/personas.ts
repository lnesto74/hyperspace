...
const merchandisingKpis: KpiTileDefinition[] = [
  ...
  },
  {
    ...
    unit: 'sec',
    format: 'seconds',
    meaning: 'Total time each shopper spent browsing ALL shelf zones combined.',
    action: 'Under 30s suggests low engagement. Improve product visibility or signage.',
    tooltip: 'Sum of dwell time across all shelf zones ÷ unique visitors. Excludes queue & checkout.',
    thresholds: { good: 60, warn: 30, bad: 15, direction: 'higher' },
  },
  {
    id: 'passbyCount',
