                ...
                >
                  <div className="flex justify-between items-start gap-2">
                    <div className="min-w-0 flex-1">
                      ...
                      {zone.category && (
                        <span
                          className="inline-block mt-0.5 rounded-full px-1.5 py-px text-[11px] font-semibold truncate max-w-full"
                          style={{
                    ...
                    {(!focusMode || zone.utilization > 0) && (
                      <span className="text-xs text-gray-400 shrink-0 tabular-nums">{zone.utilization}%</span>
                    )}
                  </div>
                </div>
              )
